...
_kubectl_annotate()
{
    ...
    two_word_flags+=("--application-metrics-count-limit")
    flags+=("--as=")
    two_word_flags+=("--as")
    flags+=("--as-group=")
    two_word_flags+=("--as-group")
    flags+=("--boot-id-file=")
    two_word_flags+=("--boot-id-file")
    flags+=("--cache-dir=")
    ...
    two_word_flags+=("--container-hints")
    flags+=("--containerd=")
    two_word_flags+=("--containerd")
    flags+=("--containerd-namespace=")
    two_word_flags+=("--containerd-namespace")
    flags+=("--context=")
    ...
    two_word_flags+=("--default-not-ready-toleration-seconds")
    flags+=("--default-unreachable-toleration-seconds=")
    two_word_flags+=("--default-unreachable-toleration-seconds")
    flags+=("--disable-root-cgroup-stats")
    flags+=("--docker=")
    two_word_flags+=("--docker")
    flags+=("--docker-env-metadata-whitelist=")
    two_word_flags+=("--docker-env-metadata-whitelist")
    flags+=("--docker-only")
    flags+=("--docker-root=")
    two_word_flags+=("--docker-root")
    flags+=("--docker-tls")
    flags+=("--docker-tls-ca=")
    two_word_flags+=("--docker-tls-ca")
    flags+=("--docker-tls-cert=")
    two_word_flags+=("--docker-tls-cert")
    flags+=("--docker-tls-key=")
    two_word_flags+=("--docker-tls-key")
    flags+=("--enable-load-reader")
    flags+=("--event-storage-age-limit=")
    two_word_flags+=("--event-storage-age-limit")
    flags+=("--event-storage-event-limit=")
    two_word_flags+=("--event-storage-event-limit")
    flags+=("--global-housekeeping-interval=")
    two_word_flags+=("--global-housekeeping-interval")
    flags+=("--housekeeping-interval=")
    two_word_flags+=("--housekeeping-interval")
    ...
    two_word_flags+=("--machine-id-file")
    ...
    flags+=("--referenced-reset-interval=")
    two_word_flags+=("--referenced-reset-interval")
    ...
    two_word_flags+=("--storage-driver-buffer-duration")
    flags+=("--storage-driver-db=")
    two_word_flags+=("--storage-driver-db")
    flags+=("--storage-driver-host=")
    two_word_flags+=("--storage-driver-host")
    flags+=("--storage-driver-password=")
    two_word_flags+=("--storage-driver-password")
    flags+=("--storage-driver-secure")
    flags+=("--storage-driver-table=")
    two_word_flags+=("--storage-driver-table")
    flags+=("--storage-driver-user=")
    two_word_flags+=("--storage-driver-user")
    flags+=("--tls-server-name=")
    two_word_flags+=("--tls-server-name")
    flags+=("--token=")
    two_word_flags+=("--token")
    flags+=("--update-machine-info-interval=")
    two_word_flags+=("--update-machine-info-interval")
    flags+=("--user=")
    two_word_flags+=("--user")
